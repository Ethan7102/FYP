...
class Ui_MainWindow(QMainWindow):
    def setupUi(self, MainWindow):
        ...
        # uav detail ui
        self.lblAirspeed = QtSvg.QSvgWidget('img/attitude_roll_2.svg')
        self.lblAirspeed.setMaximumSize(QSize(300,300))
        ...
        self.svgWidget = QtSvg.QSvgWidget('img/attitude_roll_2.svg')
        self.verticalLayout_3.addWidget(self.svgWidget)
        """
